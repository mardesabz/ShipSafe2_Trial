...
Bunkering / Fuel Transfer Permit
...
---
Quick Start
Download the latest ShipSafe 2 Trial ZIP file from this repository or from the release page.
Extract the ZIP file to a normal folder on your Windows computer.
Open the extracted folder.
Run:
```text
   ShipSafe2.exe
   ```
Complete the initial setup if requested.
Start from the Dashboard.
Choose an activity to create a Risk Assessment, or choose a Permit to Work type.
Issue the document and check it in History.
---
System Requirements
Recommended:
